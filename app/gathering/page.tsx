            ...
            <section className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center justify-between p-4 border border-gray-300 rounded-lg bg-[#f9f9ff]">
                  ...
                  >
                    <span
                      className={`absolute top-0.5 w-4 h-4 bg-white rounded-full shadow transition-transform ${policeClearance
                          ? "translate-x-5"
                          : "translate-x-0.5"
                        }`}
                    />
                ...
                <div className="flex items-center justify-between p-4 border border-gray-300 rounded-lg bg-[#f9f9ff]">
                  ...
                  >
                    <span
                      className={`absolute top-0.5 w-4 h-4 bg-white rounded-full shadow transition-transform ${fireSafety
                          ? "translate-x-5"
                          : "translate-x-0.5"
                        }`}
                    />
                ...
                <div className="flex items-center justify-between p-4 border border-gray-300 rounded-lg bg-[#f9f9ff]">
                  ...
                  >
                    <span
                      className={`absolute top-0.5 w-4 h-4 bg-white rounded-full shadow transition-transform ${sanitation
                          ? "translate-x-5"
                          : "translate-x-0.5"
                        }`}
                    />
